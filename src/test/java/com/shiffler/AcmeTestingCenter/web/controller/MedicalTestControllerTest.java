...
class MedicalTestControllerTest {
    ...
    @Test
    @DisplayName("Test getMedicalTestByIdNotFound - Element is found")
    void getMedicalTestById() throws Exception {
        ...
        MvcResult result = mockMvc
                .perform(get("/api/v1/medicaltest/" + medicalTest2.getId()))
    ...
    void getMedicalTestByIdNotFound() throws Exception {
        ...
        //When - Run the REST call against the controller
        MvcResult result = mockMvc
                .perform(get("/api/v1/medicaltest/" + medicalTest1.getId()))
    ...
    void getAllMedicalTests() throws Exception {
        ...
        //When - Run the REST call against the controller
        MvcResult result = mockMvc
                .perform(get("/api/v1/medicaltest/" ))
    ...
    void saveNewMedicalTest() throws Exception {
        ...
        assertTrue(headervalue.equals("http://localhost:8081/f1d12aae-1e44-49b5-96f6-c24cbfad7f82"));
    }
}